...
const Tab = ({ active, onClick, children }) => (
  <button
    ...
    className={`
      relative px-4 py-2 text-sm font-medium
      ${active 
        ? 'bg-[#0d1117] text-[#c9d1d9] border-t-2 border-[#f78166]' 
        : 'bg-[#161b22] text-[#8b949e] hover:text-[#c9d1d9]'}
      border-r border-l border-[#30363d]
      first:border-l-0 last:border-r-0
      transition-colors duration-200 ease-in-out
...
const ActionButton = ({ onClick, children }) => (
  <button
    onClick={onClick}
    className="p-2 text-[#8b949e] hover:text-[#388bfd] transition-colors duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#388bfd]"
  >
    {children}
  </button>
);
...
const CodeViewer = () => {
  ...
  const MainContent = () => {
    ...
    return (
      <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] p-4">
        <div className="max-w-6xl mx-auto space-y-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-[#c9d1d9]">Developer Files Viewer</h1>
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="pl-10 pr-4 py-2 bg-[#161b22] border border-[#30363d] rounded-lg text-[#c9d1d9] placeholder-[#8b949e] focus:outline-none focus:ring-2 focus:ring-[#388bfd] focus:border-[#388bfd]"
                />
              </div>
              <label className="cursor-pointer">
                <input
                  ...
                  onChange={handleFileUpload}
                />
                <Upload className="h-6 w-6 text-[#8b949e] hover:text-[#388bfd] transition-colors duration-200" />
              </label>
            </div>
          </div>
            ...
            <div className="p-4">
              {isEditing ? (
                <textarea
                  value={editContent}
                  onChange={(e) => setEditContent(e.target.value)}
                  className="w-full h-96 bg-[#0d1117] text-[#c9d1d9] font-mono p-4 rounded-lg border border-[#30363d] focus:outline-none focus:ring-2 focus:ring-[#388bfd] focus:border-[#388bfd]"
                />
              ) : (
                <div className="relative rounded-lg overflow-hidden">
                  <SyntaxHighlighter
  ...
  const LoginForm = () => (
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117]">
      <div className="bg-[#161b22] p-8 rounded-lg shadow-xl w-96 border border-[#30363d]">
        <h1 className="text-2xl font-bold text-center mb-6 text-[#c9d1d9]">Login</h1>
        <form onSubmit={handleLogin} className="space-y-4">
          <input
            type="text"
            placeholder="Username"
            value={username}
            onChange={(e) => setUsername(e.target.value)}
            className="w-full p-3 bg-[#0d1117] border border-[#30363d] rounded-lg text-[#c9d1d9] placeholder-[#8b949e] focus:outline-none focus:ring-2 focus:ring-[#388bfd] focus:border-[#388bfd]"
          />
          <input
            type="password"
            placeholder="Password"
          ...
          />
          {error && (
            <div className="text-[#f85149] text-sm text-center">{error}</div>
          )}
          <button
            type="submit"
            className="w-full bg-[#238636] text-[#c9d1d9] py-3 rounded-lg hover:bg-[#2ea043] transition duration-200 focus:outline-none focus:ring-2 focus:ring-[#388bfd]"
          >
            Login
          </button>
        </form>
